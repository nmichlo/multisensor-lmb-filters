function [rng, model] = generateModel(rng, clutterRate, detectionProbability, dataAssociationMethod, varargin)
% GENERATEMODEL -- Generates a structure containing all simulation info.
%   [rng, model] = generateModel(rng, clutterRate, detectionProbabilty);
%
